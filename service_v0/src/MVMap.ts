...
export class MVMap {
    ...
    // the MVMap
    private elementsMVMap: any; //: crdtlib.crdt.MVMap;
    private session: any;
    ...
    constructor(session: any, collection: any) {
        ...
        this.elementsMVMap = collection.open("mymvmap", "MVMap", false, function () {return});
        ...
        this.refreshBox.id = "mvmap-auto-refresh";
        ...
        boxLabel.setAttribute('for', "mvmap-auto-refresh");
        ...
        switch (this.selectType.value) {
            case "String":
                this.session.transaction(client.utils.ConsistencyLevel.None, () => {
                    this.elementsMVMap.setString(this.gInKey.value, this.gInValue.value);    
                })
                break;
            case "Int":
                ...
                this.session.transaction(client.utils.ConsistencyLevel.None, () => {
                    this.elementsMVMap.setInt(this.gInKey.value, this.gInValue.value);
                })
                break;
            case "Double":
                if (this.gInValue.value === '') {
                ...
                this.session.transaction(client.utils.ConsistencyLevel.None, () => {
                    this.elementsMVMap.setDouble(this.gInKey.value, this.gInValue.value);
                })
                break;
            case "Boolean":
                ...
                this.session.transaction(client.utils.ConsistencyLevel.None, () => {
                    this.elementsMVMap.setBoolean(this.gInKey.value, this.gInValue.value);
                })
                break;
        }
    ...
    private remove(type: string, key: string) {
        this.session.transaction(client.utils.ConsistencyLevel.None, () => {
            switch (type) {
                case "String":
                    this.elementsMVMap.deleteString(key);
                    break;
                case "Int":
                    this.elementsMVMap.deleteInt(key);
                    break;
                case "Double":
                    this.elementsMVMap.deleteDouble(key);
                    break;
                case "Boolean":
                    this.elementsMVMap.deleteBoolean(key);
                    break;
            }
        })
    ...
    private renderType(type: string) {
        ...
        this.session.transaction(client.utils.ConsistencyLevel.None, () => {
            ...
            switch (type) {
                case "String":
                    iterator = this.elementsMVMap.iteratorString();
                    break;
                case "Int":
                    iterator = this.elementsMVMap.iteratorInt();
                    break;
                case "Double":
                    iterator = this.elementsMVMap.iteratorDouble();
                    break;
                case "Boolean":
                    iterator = this.elementsMVMap.iteratorBoolean();
                    break;
            }
