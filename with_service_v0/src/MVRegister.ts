...
export class MVRegister{
    ...
    // the RGA
    private elementsMVRegister: any; //: crdtlib.crdt.RGA<string>;
    ...
    constructor(env: crdtlib.utils.Environment){
        ...
        this.gul = this.glist.appendChild(document.createTextNode(this.elementsMVRegister.get()));
        this.glist.appendChild(document.createElement("br"));
        this.glist.appendChild(document.createElement("br"));
    ...
    public doInsertString(value: string){
        ...
        this.gul.nodeValue=this.elementsMVRegister.get();
